...
@ContextConfiguration(classes = JdbcRepositoryConfigurationTest.class)
...
public abstract class AbstractJdbcRepositoryTest {
    ...
    public void setUpDbUnit() throws Exception {
        ...
        final Reader reader = new InputStreamReader(AbstractJdbcRepositoryTest.class.getResourceAsStream(resourceName));
